This is a single page website designed using HTML,CSS and some JavaScript. HTML and CSS files are separate while JavaScript code is used within the HTML file. 
